...
from utils.reset_ticker import reset_ticker
...
def main():
    try:
        parser = argparse.ArgumentParser(description="Stock Trading Bot CLI")
        parser.add_argument("--mode", choices=["backtest", "live", "sync", "bulk_sync", "reset", "clean"], required=True, help="Mode to run")
        ...
        parser.add_argument("--period", type=str, default="1y", help="Period for sync (e.g. 1y, 10y)")
