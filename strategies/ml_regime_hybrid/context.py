...
class FeaturesContext:
    ...
    Feature: ROC
        ...
        Params: {'period': 20}
    """
    MOVINGAVERAGE_252_SMA: str = 'Norm_MovingAverage_252_SMA'
    """
    Feature: Moving Average
        Outputs: Primary
        Params: {'period': 252, 'type': 'SMA', 'normalize': 'pct_distance'}
    """
    OBV: str = 'OBV'
    """
...
class ParamsContext:
    ...
    high_vol_threshold: float = 0.9
    atr_lookback: int = 246
    vol_expansion_limit: float = 0.25
    entry_quality_threshold: float = 0.3
    exit_quality_threshold: float = 0.25
    min_hold_days: int = 5
    min_adx_entry: int = 12
